...
description: Capture learnings about Alex's content voice and style preferences and propagate them to reference files and dependent content skills. Use when Alex gives feedback on generated content ("this felt too formal", "the hook on B was better because..."), when voice patterns emerge across multiple sessions, when Alex says "update the style guide", "add this to the voice rules", or "propagate this voice learning". Cascades updates across content-style-guide.md, content-anti-patterns.md, outreach-templates.md, and the two-thesis-synthesis pattern file.
---
