...
- `databases/database-designer` — when you've chosen a model here and need to
  generate the schema, indexes, RLS policies, and migrations. This skill is
  the *theory*; database-designer is the *implementation tool*.
